...
const FALLBACK_ANIME: MediaSummary[] = [
  {
    ...
    media_type: "anime",
    title: "One Piece",
    poster_url: placeholderPoster("One Piece"),
    backdrop_url: placeholderPoster("One Piece", "backdrop"),
    release_year: 1999,
    vote_average: 8.7,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("Attack on Titan"),
    backdrop_url: placeholderPoster("Attack on Titan", "backdrop"),
    release_year: 2013,
    vote_average: 8.8,
    genres: ["Action", "Drama"],
    runtime: 24,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Death Note",
    poster_url: placeholderPoster("Death Note"),
    backdrop_url: placeholderPoster("Death Note", "backdrop"),
    release_year: 2006,
    vote_average: 8.6,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Frieren",
    poster_url: placeholderPoster("Frieren"),
    backdrop_url: placeholderPoster("Frieren", "backdrop"),
    release_year: 2023,
    vote_average: 8.9,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Demon Slayer",
    poster_url: placeholderPoster("Demon Slayer"),
    backdrop_url: placeholderPoster("Demon Slayer", "backdrop"),
    release_year: 2019,
    vote_average: 8.7,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("Jujutsu Kaisen"),
    backdrop_url: placeholderPoster("Jujutsu Kaisen", "backdrop"),
    release_year: 2020,
    vote_average: 8.6,
    genres: ["Action", "Fantasy"],
    runtime: 24,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Steins;Gate",
    poster_url: placeholderPoster("Steins;Gate"),
    backdrop_url: placeholderPoster("Steins;Gate", "backdrop"),
    release_year: 2011,
    vote_average: 9.1,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Cowboy Bebop",
    poster_url: placeholderPoster("Cowboy Bebop"),
    backdrop_url: placeholderPoster("Cowboy Bebop", "backdrop"),
    release_year: 1998,
    vote_average: 8.9,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("Fullmetal Alchemist"),
    backdrop_url: placeholderPoster("Fullmetal Alchemist", "backdrop"),
    release_year: 2009,
    vote_average: 9.2,
    genres: ["Action", "Fantasy"],
    runtime: 24,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("Sousou no Frieren"),
    backdrop_url: placeholderPoster("Sousou no Frieren", "backdrop"),
    release_year: 2023,
    vote_average: 9.0,
    genres: ["Fantasy", "Adventure"],
    runtime: 24,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Steins;Gate 0",
    poster_url: placeholderPoster("Steins;Gate 0"),
    backdrop_url: placeholderPoster("Steins;Gate 0", "backdrop"),
    release_year: 2018,
    vote_average: 8.3,
    genres: ["Sci-Fi", "Drama"],
    runtime: 24,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Spy x Family",
    poster_url: placeholderPoster("Spy x Family"),
    backdrop_url: placeholderPoster("Spy x Family", "backdrop"),
    release_year: 2022,
    vote_average: 8.4,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Chainsaw Man",
    poster_url: placeholderPoster("Chainsaw Man"),
    backdrop_url: placeholderPoster("Chainsaw Man", "backdrop"),
    release_year: 2022,
    vote_average: 8.4,
    genres: ["Action", "Fantasy"],
    runtime: 24,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("Mob Psycho 100"),
    backdrop_url: placeholderPoster("Mob Psycho 100", "backdrop"),
    release_year: 2016,
    vote_average: 8.7,
    genres: ["Action", "Comedy"],
    runtime: 24,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("Hunter x Hunter"),
    backdrop_url: placeholderPoster("Hunter x Hunter", "backdrop"),
    release_year: 2011,
    vote_average: 8.9,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Vinland Saga",
    poster_url: placeholderPoster("Vinland Saga"),
    backdrop_url: placeholderPoster("Vinland Saga", "backdrop"),
    release_year: 2019,
    vote_average: 8.7,
    genres: ["Action", "Drama"],
    runtime: 24,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("Violet Evergarden"),
    backdrop_url: placeholderPoster("Violet Evergarden", "backdrop"),
    release_year: 2018,
    vote_average: 8.7,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Haikyuu!!",
    poster_url: placeholderPoster("Haikyuu"),
    backdrop_url: placeholderPoster("Haikyuu", "backdrop"),
    release_year: 2014,
    vote_average: 8.5,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("Kaguya-sama"),
    backdrop_url: placeholderPoster("Kaguya-sama", "backdrop"),
    release_year: 2019,
    vote_average: 8.3,
  ...
  },
  {
    ...
    media_type: "anime",
    title: "Dandadan",
    poster_url: placeholderPoster("Dandadan"),
    backdrop_url: placeholderPoster("Dandadan", "backdrop"),
    release_year: 2024,
    vote_average: 8.3,
    genres: ["Action", "Comedy"],
    runtime: 24,
...
const FALLBACK_MANGA: MediaSummary[] = [
  {
    ...
    media_type: "manga",
    title: "One Piece",
    poster_url: placeholderPoster("One Piece Manga"),
    backdrop_url: placeholderPoster("One Piece Manga", "backdrop"),
    release_year: 1997,
    vote_average: 8.5,
    genres: ["Adventure", "Action"],
    chapter_count: 1100,
  ...
  },
  {
    ...
    media_type: "manga",
    title: "Berserk",
    poster_url: placeholderPoster("Berserk"),
    backdrop_url: placeholderPoster("Berserk", "backdrop"),
    release_year: 1989,
    vote_average: 9.1,
    genres: ["Action", "Fantasy"],
    chapter_count: 370,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("AoT Manga"),
    backdrop_url: placeholderPoster("AoT Manga", "backdrop"),
    release_year: 2009,
    vote_average: 8.7,
    genres: ["Action", "Drama"],
    chapter_count: 139,
  ...
  },
  {
    ...
    media_type: "manga",
    title: "Vagabond",
    poster_url: placeholderPoster("Vagabond"),
    backdrop_url: placeholderPoster("Vagabond", "backdrop"),
    release_year: 1998,
    vote_average: 9.0,
    genres: ["Action", "Drama"],
    chapter_count: 327,
  ...
  },
  {
    ...
    media_type: "manga",
    title: "Monster",
    poster_url: placeholderPoster("Monster"),
    backdrop_url: placeholderPoster("Monster", "backdrop"),
    release_year: 1994,
    vote_average: 9.0,
    genres: ["Mystery", "Thriller"],
    chapter_count: 162,
  ...
  },
  {
    ...
    media_type: "manga",
    title: "Goodbye, Eri",
    poster_url: placeholderPoster("Goodbye Eri"),
    backdrop_url: placeholderPoster("Goodbye Eri", "backdrop"),
    release_year: 2022,
    vote_average: 8.5,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("20th Century Boys"),
    backdrop_url: placeholderPoster("20th Century Boys", "backdrop"),
    release_year: 1999,
    vote_average: 8.8,
  ...
  },
  {
    ...
    media_type: "manga",
    title: "Pluto",
    poster_url: placeholderPoster("Pluto"),
    backdrop_url: placeholderPoster("Pluto", "backdrop"),
    release_year: 2003,
    vote_average: 8.7,
    genres: ["Mystery", "Sci-Fi"],
    chapter_count: 65,
  ...
  },
  {
    ...
    media_type: "manga",
    title: "Kingdom",
    poster_url: placeholderPoster("Kingdom"),
    backdrop_url: placeholderPoster("Kingdom", "backdrop"),
    release_year: 2006,
    vote_average: 8.8,
    genres: ["Action", "Drama"],
    chapter_count: 770,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("Oyasumi Punpun"),
    backdrop_url: placeholderPoster("Oyasumi Punpun", "backdrop"),
    release_year: 2007,
    vote_average: 8.6,
  ...
  },
  {
    ...
    media_type: "manga",
    title: "Slam Dunk",
    poster_url: placeholderPoster("Slam Dunk"),
    backdrop_url: placeholderPoster("Slam Dunk", "backdrop"),
    release_year: 1990,
    vote_average: 8.6,
    genres: ["Sports", "Drama"],
    chapter_count: 276,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("JJK Manga"),
    backdrop_url: placeholderPoster("JJK Manga", "backdrop"),
    release_year: 2018,
    vote_average: 8.4,
    genres: ["Action", "Fantasy"],
    chapter_count: 270,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("CSM Manga"),
    backdrop_url: placeholderPoster("CSM Manga", "backdrop"),
    release_year: 2018,
    vote_average: 8.5,
    genres: ["Action", "Fantasy"],
    chapter_count: 190,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("DS Manga"),
    backdrop_url: placeholderPoster("DS Manga", "backdrop"),
    release_year: 2016,
    vote_average: 8.3,
    genres: ["Action", "Fantasy"],
    chapter_count: 205,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("FMA Manga"),
    backdrop_url: placeholderPoster("FMA Manga", "backdrop"),
    release_year: 2001,
    vote_average: 8.9,
    genres: ["Action", "Fantasy"],
    chapter_count: 108,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("DN Manga"),
    backdrop_url: placeholderPoster("DN Manga", "backdrop"),
    release_year: 2003,
    vote_average: 8.6,
    genres: ["Mystery", "Thriller"],
    chapter_count: 108,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("HxH Manga"),
    backdrop_url: placeholderPoster("HxH Manga", "backdrop"),
    release_year: 1998,
    vote_average: 8.5,
    genres: ["Action", "Adventure"],
    chapter_count: 410,
  ...
  },
  {
    ...
    media_type: "manga",
    title: "Haikyuu!! Manga",
    poster_url: placeholderPoster("Haikyuu Manga"),
    backdrop_url: placeholderPoster("Haikyuu Manga", "backdrop"),
    release_year: 2012,
    vote_average: 8.4,
    genres: ["Sports", "Comedy"],
    chapter_count: 402,
  ...
  },
  {
    ...
    source: "anilist",
    media_type: "manga",
    title: "Kaguya-sama Manga",
    poster_url: placeholderPoster("Kaguya Manga"),
    backdrop_url: placeholderPoster("Kaguya Manga", "backdrop"),
    release_year: 2015,
    vote_average: 8.3,
    genres: ["Comedy", "Romance"],
    chapter_count: 281,
  ...
  },
  {
    ...
    poster_url: placeholderPoster("SxF Manga"),
    backdrop_url: placeholderPoster("SxF Manga", "backdrop"),
    release_year: 2019,
    vote_average: 8.2,
    genres: ["Action", "Comedy"],
    chapter_count: 105,
...
function toSummary(a: AniListMedia): MediaSummary {
  ...
  return {
    ...
    vote_average:
      a.averageScore !== null && a.averageScore !== undefined ? a.averageScore / 10 : null,
    genres: a.genres ?? [],
  ...
  .handler(async ({ data }) => {
    try {
      ...
      if (data.page === 1) {
        ...
        const current =
          currentRes.status === "fulfilled" ? (currentRes.value.Page.media ?? []) : [];
      ...
      const result = await anilist<{ Page: { media: AniListMedia[] } }>(
      ...
      }`,
        {
          ...
          year,
          page: data.page,
          genreIn: genreList.length > 0 ? genreList : undefined,
        },
      );
      return (result.Page.media ?? []).map(toSummary);
    } catch (error) {
...
export const getAnimeDetails = createServerFn({ method: "GET" })
  ...
  .handler(async ({ data }) => {
    try {
      ...
      throw new Error(
        `Failed to load anime details: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  });
...
export const getMangaDetails = createServerFn({ method: "GET" })
  ...
  .handler(async ({ data }) => {
    try {
      ...
      throw new Error(
        `Failed to load manga details: ${error instanceof Error ? error.message : "Unknown error"}`,
      );
    }
  });
      ...
      data.ids.slice(0, 8).map((mid) =>
        anilist<{ Media: AniListMedia }>(
          ...
          return {
            ...
            images: {
              jpg: {
                large_image_url: a.coverImage?.extraLarge ?? null,
