...
export function PageHeader({
  ...
  return (
    <div className={cn("mb-8 animate-fade-in", className)}>
      <div className="relative overflow-hidden rounded-[28px] border border-[rgba(148,163,184,0.16)] bg-[linear-gradient(135deg,rgba(12,17,28,0.96),rgba(17,24,39,0.88))] p-5 shadow-[0_18px_46px_rgba(15,23,42,0.24)] md:p-7">
